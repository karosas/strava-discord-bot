...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MovingStream :  IEquatable<MovingStream>, IValidatableObject
    {
        /// <summary>
        ...
        public MovingStream(int? originalSize = default(int?), ResolutionEnum? resolution = default(ResolutionEnum?), SeriesTypeEnum? seriesType = default(SeriesTypeEnum?), List<bool?> data = default(List<bool?>))
        {
