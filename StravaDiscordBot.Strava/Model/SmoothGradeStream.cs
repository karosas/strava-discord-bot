...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SmoothGradeStream :  IEquatable<SmoothGradeStream>, IValidatableObject
    {
        /// <summary>
        ...
        public SmoothGradeStream(int? originalSize = default(int?), ResolutionEnum? resolution = default(ResolutionEnum?), SeriesTypeEnum? seriesType = default(SeriesTypeEnum?), List<float?> data = default(List<float?>))
        {
