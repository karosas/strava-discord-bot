...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class HeartrateStream :  IEquatable<HeartrateStream>, IValidatableObject
    {
        /// <summary>
        ...
        public HeartrateStream(int? originalSize = default(int?), ResolutionEnum? resolution = default(ResolutionEnum?), SeriesTypeEnum? seriesType = default(SeriesTypeEnum?), List<int?> data = default(List<int?>))
        {
