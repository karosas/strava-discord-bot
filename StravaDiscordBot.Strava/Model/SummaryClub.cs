...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SummaryClub :  IEquatable<SummaryClub>, IValidatableObject
    {
        /// <summary>
        /// Defines SportType
        /// </summary>
        ...
        public SummaryClub(long? id = default(long?), int? resourceState = default(int?), string name = default(string), string profileMedium = default(string), string coverPhoto = default(string), string coverPhotoSmall = default(string), SportTypeEnum? sportType = default(SportTypeEnum?), string city = default(string), string state = default(string), string country = default(string), bool? _private = default(bool?), int? memberCount = default(int?), bool? featured = default(bool?), bool? verified = default(bool?), string url = default(string))
        {
            this.Id = id;
