...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PowerStream :  IEquatable<PowerStream>, IValidatableObject
    {
        /// <summary>
        ...
        public PowerStream(int? originalSize = default(int?), ResolutionEnum? resolution = default(ResolutionEnum?), SeriesTypeEnum? seriesType = default(SeriesTypeEnum?), List<int?> data = default(List<int?>))
        {
