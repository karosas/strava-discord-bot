...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CadenceStream :  IEquatable<CadenceStream>, IValidatableObject
    {
        /// <summary>
        ...
        public CadenceStream(int? originalSize = default(int?), ResolutionEnum? resolution = default(ResolutionEnum?), SeriesTypeEnum? seriesType = default(SeriesTypeEnum?), List<int?> data = default(List<int?>))
        {
