...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AltitudeStream :  IEquatable<AltitudeStream>, IValidatableObject
    {
        /// <summary>
        ...
        public AltitudeStream(int? originalSize = default(int?), ResolutionEnum? resolution = default(ResolutionEnum?), SeriesTypeEnum? seriesType = default(SeriesTypeEnum?), List<float?> data = default(List<float?>))
        {
