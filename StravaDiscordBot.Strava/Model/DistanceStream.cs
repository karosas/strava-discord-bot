...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DistanceStream :  IEquatable<DistanceStream>, IValidatableObject
    {
        /// <summary>
        ...
        public DistanceStream(int? originalSize = default(int?), ResolutionEnum? resolution = default(ResolutionEnum?), SeriesTypeEnum? seriesType = default(SeriesTypeEnum?), List<float?> data = default(List<float?>))
        {
