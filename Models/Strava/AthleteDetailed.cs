...
namespace StravaDiscordBot.Models.Strava
{
    public class AthleteDetailed
    {
        ...
        [JsonProperty("badge_type_id")] public long? BadgeTypeId { get; set; }

        [JsonProperty("profile_medium")] public Uri ProfileMedium { get; set; }

        [JsonProperty("profile")] public Uri Profile { get; set; }
        ...
        [JsonProperty("friend_count")] public long? FriendCount { get; set; }

        [JsonProperty("mutual_friend_count")] public long? MutualFriendCount { get; set; }

        [JsonProperty("athlete_type")] public long? AthleteType { get; set; }

        [JsonProperty("date_preference")] public string DatePreference { get; set; }

        [JsonProperty("measurement_preference")]
        public string MeasurementPreference { get; set; }

        [JsonProperty("clubs")] public object[] Clubs { get; set; }

        [JsonProperty("ftp")] public object Ftp { get; set; }
